...
int main() {
   ...
   const char* searchKey1 = "Tesla";
   if (search(Cres, C, 8, searchKey1)) {
   ...
   double searchKey2 = 4.0;
   if (search(Sres, S, 6, searchKey2)) {
